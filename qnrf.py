...
class DatasetQNRF(torch.utils.data.Dataset):
    def __init__(self, data_path, meta_path, mode, rough_path=None):
        super(DatasetQNRF, self).__init__()
